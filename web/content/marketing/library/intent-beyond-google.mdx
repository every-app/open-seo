...
![SEOShark keyword research results with the intent column labelling each keyword informational, navigational, commercial or transactional](/library/keyword-research/intent-by-surface-seoshark.png)
...
```text
Using the SEOShark MCP, research keywords for "[my topic]" and label
