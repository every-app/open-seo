...
![A backlink profile panel showing 596,564 backlinks, 13,980 referring domains, 408,922 referring pages, rank 67, backlink spam score 23.0, 2,217 broken backlinks, 529 broken pages, and target spam score 0.0](/library/competitive-analysis/competitor-backlink-profile-seoshark.png)
...
The pattern shows up constantly among founders: they want to increase their domain rating because that is what everyone talks about and what link sellers market. But is that going to get you any organic traffic?
...
## How to run a link gap in SEOShark

As with the keyword gap, SEOShark does not ship a single "link gap" report that diffs two domains. You pull the [backlink profile](/features/backlink-checker) for each side and let the agent do the comparison, which lets you set the quality filters yourself rather than inheriting somebody's defaults.

```text
Using the SEOShark MCP, compare the link profiles of
