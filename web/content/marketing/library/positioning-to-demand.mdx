...
"Is anyone even Googling this" is the whole play in five words. Notice what the check gave him beyond a yes or no. It also returned the vocabulary the market does use: agencies, freelancers, and the space between them. A term with no volume is not only a warning. It is a pointer to the words that carry the demand instead.
