...
**2. Which of my pages compete with each other?** Search Console by query and page. Any query with two of your URLs is a page fighting itself, and the fix is an internal link or a merge, not new content. [Cluster keywords into topical hubs](/library/keyword-research/cluster-topical-hubs) covers it.
