...
- Help you choose the next SEOShark Agent Skill based on your goal.
- Distinguish strategy questions from execution work.
- Explain when to use SEOShark MCP, saved project context, web search, browser review, or local files.
...
- "What does SEOShark help my agent do?"
...
The coach can help before MCP is connected, but your agent needs [SEOShark MCP](/docs/mcp) for live keyword, SERP, domain, backlink, and saved keyword data.

## Read the actual skill

The source `SKILL.md` lives on GitHub:

- [SEO Coach skill](https://github.com/bizztor/seoshark/tree/main/.agents/skills/seo-coach)
