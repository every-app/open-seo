---
title: "SEOShark Agent Skills"
description: "Add SEOShark Agent Skills to Claude Code, Codex, or another AI agent so it can run repeatable SEO workflows with live SEOShark data."
---

SEOShark Agent Skills let you hand repeatable SEO workflows to your AI agent.
...
You stay in charge of strategy. Your agent uses SEOShark data and the skill instructions to research the answer, then saves the result as a report in your project.

No account yet? Try the [free SEO tools](/tools).

## Set up SEOShark Agent Skills

On Claude Code, the [SEOShark plugin](/docs/claude-code-plugin) installs MCP and every skill below in one step. On Codex CLI, the [SEOShark plugin](/docs/codex-plugin) does the same. Use the manual steps here for other agents, or if you want to pick individual skills.

1. [Set up SEOShark MCP](/docs/mcp).
2. [Set up SEOShark Agent Skills](/docs/skills/setup).

MCP connects your agent to SEOShark data. Skills tell your agent which SEO workflow to run.
...
SEOShark uses the same `SKILL.md` pattern supported by modern AI agents. To learn how skills work in your agent, read:
