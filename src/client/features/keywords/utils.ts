...
// overrides that stay readable on the dark glass surface.
export function scoreTierClass(value: number | null): string {
  ...
  if (value <= 35) return "bg-lime-400/15 text-lime-300 ring-lime-400/30";
  if (value <= 50) return "bg-warning/15 text-warning ring-warning/30";
  if (value <= 65) return "bg-orange-400/15 text-orange-300 ring-orange-400/30";
  if (value <= 80) return "bg-destructive/20 text-red-300 ring-destructive/35";
  return "bg-destructive/30 text-rose-300 ring-destructive/50";
}
