...
export function OverviewStats({ keyword }: { keyword: KeywordResearchRow }) {
  return (
    <div className="shrink-0 bg-card border border-border rounded-xl px-4 py-2.5 flex items-center gap-4 min-h-[48px]">
      ...
      <div className="flex items-center gap-4 text-sm flex-wrap min-w-0">
        ...
        <div className="flex items-center gap-1.5">
          <span className="text-muted-foreground/70">CPC</span>
          <span className="font-semibold tabular-nums">
