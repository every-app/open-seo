  ...
  return (
    <div className="h-[100dvh] overflow-y-auto bg-[#070909] text-white">
      ...
      <header className="relative z-10 mx-auto flex max-w-7xl items-center justify-between px-5 py-5 sm:px-8">
        ...
        >
          <span className="grid size-9 place-items-center rounded-xl bg-emerald-400 text-sm font-black text-black">
            D
          </span>
          <span>DGTL SEO Tools</span>
        </Link>
        <nav className="flex items-center gap-2">
          <Link to="/sign-in" className="btn btn-ghost btn-sm text-white">
            Sign in
          </Link>
          <Link
            to="/sign-up"
            className="btn btn-sm border-0 bg-white text-black hover:bg-white/90"
          >
            Create account
          </Link>
        </nav>
        ...
        <section className="mx-auto grid max-w-7xl items-center gap-12 px-5 pb-20 pt-16 sm:px-8 lg:grid-cols-[1.05fr_.95fr] lg:py-28">
          <div>
            ...
            <p className="mt-6 max-w-2xl text-lg leading-8 text-white/60">
              Give each client an isolated dashboard for website performance,
              problem reports, GA4 analytics, and Microsoft Clarity
              insights—managed centrally by DGTL.
            </p>
            <div className="mt-8 flex flex-wrap gap-3">
              <Link
                to="/sign-up"
                className="btn border-0 bg-emerald-400 text-black hover:bg-emerald-300"
              >
