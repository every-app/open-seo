  ...
  return (
    <RadioPrimitive.Root
      ...
      className={cn(
        ...
        "data-checked:shadow-[0_2px_4px_-1px_color-mix(in_oklch,var(--shade)_30%,transparent),inset_0_1px_0_oklch(1_0_0/0.18)]",
        className,
      )}
      {...props}
    >
      ...
      >
        <div className="h-2.5 w-2.5 rounded-full bg-gradient-to-t from-primary to-primary/85 shadow-[0_1px_2px_color-mix(in_oklch,var(--shade)_35%,transparent),inset_0_1px_0_oklch(1_0_0/0.25)]" />
      </RadioPrimitive.Indicator>
    </RadioPrimitive.Root>
  );
}
