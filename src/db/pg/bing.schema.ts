...
// Connected Bing Webmaster property per project.
// OAuth tokens live in the better-auth `account` table under providerId
// "bing-webmaster"; this row only records which verified property maps to a
// project and whose grant to use when calling the Bing Webmaster API.
export const bingConnections = pgTable(
  "bing_connections",
  {
    ...
    // Stored verbatim from Bing Webmaster's site list.
    siteUrl: text("site_url").notNull(),
    // Whose bing-webmaster grant getAccessToken should use.
