                  ...
                  <span className="flex min-w-0 flex-col">
                    <span className="flex items-center gap-2">
                      ...
                      {project.id === currentProjectId ? (
                        <span className="shrink-0 rounded-full bg-border/70 px-1.5 py-0.5 text-[10px] font-medium uppercase tracking-wide text-muted-foreground">
                          Current
                        </span>
                      ) : null}
                    </span>
...
function ArchivedProjects() {
  ...
  return (
    <section className="space-y-3">
      <h2 className="text-sm font-medium text-muted-foreground/70">Archived</h2>
      <ul className="divide-y divide-border overflow-hidden rounded-lg border border-border">
