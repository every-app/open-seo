/* eslint-disable max-lines, max-lines-per-function -- This module emits one self-contained browser script; splitting the template would obscure execution order across consent defaults, persistence, and tag loading. */
