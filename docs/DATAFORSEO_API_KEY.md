...
SEOShark uses [DataForSEO](https://dataforseo.com) to fetch SEO data. It's a pay-as-you-go third-party service unaffiliated with SEOShark. You need an API key to connect SEOShark to it.
