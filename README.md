...
Either way, you need a DataForSEO API key to get SEO data. See [`docs/DATAFORSEO_API_KEY.md`](./docs/DATAFORSEO_API_KEY.md). Optionally, [RankParse](./docs/RANKPARSE_API_KEY.md) can be used instead of DataForSEO for the Backlinks feature specifically — see that doc for what's different.
